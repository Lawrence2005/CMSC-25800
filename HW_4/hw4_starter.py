"""
Starter file for HW4 Part 1 and Part 2 CMSC 25800 Spring 2026
"""
...
model.load_state_dict(
    torch.load("./models/vgg16_gtsrb.pth", map_location=device)
)
model.eval()
...
def part1(image: Image.Image) -> Image.Image:
    ...
    trigger_size = 4
    img_array[h - trigger_size : h, w - trigger_size : w, :] = 255  # white square trigger
    triggered_img = Image.fromarray(img_array.astype(np.uint8))
...
"""
Submit:
1. this file with completed part1 function that applies your trigger to an image 
   and part2 function that detects poison. -> 'hw4_starter.py'
